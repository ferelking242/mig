...
<h1 align="center">MIG · FlixQuest</h1>
...
## MIG standalone repository

This repository contains the real FlixQuest application screens and Android
target used by MIG. The Watchtower-only fixture preview and design mockups
were removed. The app uses the public `better_player_plus` Git dependency so
it can build from a clean checkout without a sibling repository.
...
The standalone MIG project uses the Git URL directly:
